<?php
  ...
  $id=$_REQUEST['id'];
  $consulta="SELECT * FROM inventario_insumo WHERE id_inventario_insumo='$id'";
      ...
      <div class="page-title">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form id="formulario" class="formulario" action="modificar_inv_insumo.php?id=<?php echo $id; ?>" method="post" >
