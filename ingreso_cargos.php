      ...
      <div class="page-title">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form id="formulario" class="formulario" action="guardar_cargo.php" method="post" >
                <fieldset class="fieldset_normal">
                  ...
                  <div class="cont_cajas">
                    ...
                    <input type="txt" name="cargo" value="" placeholder="" required onkeypress="return sololetras(event)" onpaste="return false">
                  </div>
              ...
              ?>
                ...
                <td>
                  <div class="cont_tbn_tb">
                    <a href="editar_cargo.php?idc=<?php echo $row['id_cargos']; ?>">
                    ...
                    <script type="text/javascript">
                      $('.eliminar').click(function(e){
                        if (confirm("¿Está segur@ de ELIMINAR?")){
                          document.location.href="eliminar_cargo.php?id=<?php echo $row['id_cargos'];?>";
                        }else{
