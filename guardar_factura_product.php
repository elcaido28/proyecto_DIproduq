...
$ingreso=mysqli_query($con,"INSERT into factura_productos (num_factu,fecha,hora,id_tipo_pago,valort,descuento,subtotal,iva,totalp,vendedor,id_clientes,id_empleados)
...
// OBTENER ID DE LA CABEZERA_VENTAS GUARDADA
 $consulta=mysqli_query($con,"SELECT * from factura_productos ORDER BY id_factura_productos ASC ");
  while($row=mysqli_fetch_array($consulta)){
    $id_factura_productos=$row['id_factura_productos'];
  }
