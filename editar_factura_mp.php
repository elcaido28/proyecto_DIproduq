<?php
  ...
  $id=$_REQUEST['id'];
  $consult3=mysqli_query($con,"SELECT * from factura_mp F INNER JOIN clientes C on C.id_clientes=F.id_clientes where id_factura_mp='$id' ");
...
function buscar_produ_factura_prod(consults){
  ...
  $.ajax({
    url: 'ajax/ajax_productos_facturas_mp.php',
    type: 'POST',
    dataType: 'html',
  ...
  if(respuesta!=0 || respuesta!=""){
    ...
    $('#tabla2').html(respu);
    var id=<?php echo $id; ?>;
    var url1='modificar_factura_mp.php?cont='+cont+'&id='+id+'';
              ...
              <form id="form21" class="formulario" action="" method="post" >
                <fieldset class="fieldset_grande">
                  ...
                  <div class="cont_cajas_peque">
                    ...
                    <input type="txt" name="nfactura" value="<?php echo $rows3['num_factura'] ?>" placeholder="" required >
                  </div>
                  <div class="cont_cajas_peque">
                  ...
                  <div class="conten_botom_formu">
                    ...
                    <a href="lista_factura_mp.php" class="cancelar">Cancelar</a>
                  </div>
                </fieldset>
              </form>
            </div>
...
<script type="text/javascript">
    ...
    var id2=<?php echo $id; ?>;
    var url2='modificar_factura_mp.php?cont='+con+'&id='+id2+'';
