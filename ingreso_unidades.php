      ...
      <div class="page-title">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form id="formulario" class="formulario" action="guardar_unidad.php" method="post" >
                <fieldset class="fieldset_normal">
                  ...
                  <div class="cont_cajas">
                    ...
                    <input type="txt" name="unidad" value="" placeholder="" required >
                  </div>
        ...
        <div class="table-responsive">
          <div class="cont_tabla">
            <table class="tabla" >
              ...
              <tr>
              <?php
                $consulta=mysqli_query($con,"SELECT * from unidad");
              ...
              ?>
                ...
                <td>
                  <div class="cont_tbn_tb">
                    <a href="editar_unidad.php?idc=<?php echo $row['id_unidad']; ?>">
                    ...
                    <script type="text/javascript">
                      $('.eliminar').click(function(e){
                        if (confirm("¿Está segur@ de ELIMINAR?")){
                          document.location.href="eliminar_unidad.php?id=<?php echo $row['id_unidad'];?>";
                        }else{
                          document.location.href="ingreso_unidades.php";
                        }
                      })
                    </script>
                  </div>
